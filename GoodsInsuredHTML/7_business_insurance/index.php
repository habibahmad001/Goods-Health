            ...
            <div class="main">
               <div class="wrapper">
                    <div class="banner_con">
                        <div class="heading-section-login">
                        <img src="img/site/in1.png" alt="">
                        Login
                        <div class="">
                            <div class="login-page-container">
                                ...
                                <p>
                                    <a href="javascript:void(0);" class="forgot">Forgot User ID / password</a>
                                </p>
                                <p>
                                    <input type="checkbox" name=""> <span class="login-remember-me">Remember Me</span>
                                </p>
                                <p>
                                    <input type="submit" name="login" value="Login">
                                </p>
                                <p>
                                    <a href="javascript:void(0);" class="login-signup-text">Sign up for an account.</a>
                                </p>
                            </div>
                        </div>
                    </div>
