        ...
        <div id="full_wrapper">
            ...
            <header>
                <div class="top_head cf">
                    ...
                    <div class="right">
                        <a href="javascrip:void(0)">
                            <img src="../img/site/health-insurance-logo.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="bottom_head">
                    ...
                    <div class="bottom_wrap cf">
                        <div class="nav_left">
                            <ul>
                                <li>
                                    <a href="javascript:void(0)" class="location">Quote Location &nbsp;&nbsp;<img src="img/site/pin.png" alt=""></a>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li class="drop_infomation">
                                    ...
                                    <ul class="info_drop">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <span><img src="../img/site/goodsinsured-menu.png" alt=""></span>
                                                <h6>About Goods Insured</h6>
                                            </a>
                                            <ul class="inner_drop">
            ...
            <div class="main">
               <div class="wrapper">
                    ...
                    <div class="main-area-class">
                        <img src="../img/site/customer-login-left.png" />
                        <div class="area-class-right">
                            <form name="clogin-frm" id="clogin-frm" method="post">
                                <div class="frm-container">
                                    ...
                                    <div class="frm-row" id="frm-captcha">
                                        <img src="../img/site/captcha.png" />
                                    </div>
                                    <div class="frm-row" id="frm-txt">
                                        <span class="login-frm-txt">Forgot User ID / Password?</span>
                                        <span class="login-frm-txt">Signup here for an account.</span>
                                    </div>
                                </div>
                            </form>
                        </div>
