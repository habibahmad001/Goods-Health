<div class="wrap_con box_shadow">
    <div class="full_wrap">
            <form method="POST" action="#" enctype="multipart/form-data" id="form_addEmployeeUser">
                                    ...
                                    <div class="col-sm-12  profile_card">
                                        <div class="row">
                                            <div class="col-md-12 text-center pt-5 pb-5">
                                                <button class="btn btn-submit" type="submit" id="addEmployeeUserSubmitBtn">{{ __('SAVE') }}</button>
