                    ...
                    <div class="row provider_profile_edit">
                        ...
                        <div class="col-md-5 info_con profile_info_con">
                            <div class="form-group row in_field">
                                ...
                                <label for="suffix" class="col-md-4 col-form-label">Insured Number</label>
                                <div class="col-md-8 input_f">
                                    <input type="text" class="in form-control-plaintext" id="suffix" value="">
                                </div>
                                <label for="spouse" class="col-md-4 col-form-label">Effective From</label>
                                <div class="col-md-8 input_f">
                        ...
                        <div class="col-md-5 info_con profile_info_con">
                            <div class="form-group row in_field">
                                ...
                                <label for="spouse" class="col-md-4 col-form-label">Policy Number</label>
                                <div class="col-md-8 input_f">
                                    <input type="text" class="in form-control-plaintext" id="spouse" value="">
                                </div>
                                <label for="spouse" class="col-md-4 col-form-label">Effective To</label>
                                <div class="col-md-8 input_f">
                                    <input type="text" class="in form-control-plaintext" id="spouse" value="">
                                </div>
                            </div>
