<input type="hidden" name="activity_type" value="event">
<input type="hidden" name="event_id" value="{{ !empty($activity_data->id) ? $activity_data->id: '' }}">
<div class="form-group row in_field no-border p-0">
    <label for="title" class="col-md-4 col-form-label"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Title</label>
    ...
    <label for="start_datetime" class="col-md-4 col-form-label"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;&nbsp;Event Date</label>
    <div class="col-md-8 input_f">
        <input type="text" class="in form-control-plaintext input-small form-current-date" id="start_datetime" name="start_datetime" value="{{ !empty($activity_data->start_datetime) ? date('m/d/Y', strtotime($activity_data->start_datetime)) : '' }}" {{ $action_type == 'view'? 'readonly' : ''}}>
    </div>

    <!-- <label for="end_datetime" class="col-md-4 col-form-label"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;&nbsp;End Date</label>
    <div class="col-md-8 input_f">
        <input type="text" class="in form-control-plaintext input-small form-current-date" id="end_datetime" name="end_datetime">
    </div> -->
    @if($action_from != 'module')
    <label for="user_type_id" class="col-md-4 col-form-label"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;User Type</label>
    <div class="col-md-8 input_f">
        @if($action_type == 'view')
    ...
    <label for="user_id" class="col-md-4 col-form-label"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;User</label>
    <div class="col-md-8 input_f">
        @if($action_type == 'view')
    ...
    @endif
    <label for="location" class="col-md-4 col-form-label"><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;&nbsp;Location</label>
    <div class="col-md-8 input_f">
        <input type="text" class="in form-control-plaintext input-small" id="location" name="location" value="{{ !empty($activity_data->location) ? $activity_data->location : '' }}" {{ $action_type == 'view'? 'readonly' : ''}}>
    </div>

    <label for="reminder_1" class="col-md-4 col-form-label"><i class="fa fa-bell" aria-hidden="true"></i>&nbsp;&nbsp;Reminder 1</label>
    <div class="col-md-8 input_f">
        @if($action_type == 'view')
    ...
    <label for="reminder_2" class="col-md-4 col-form-label"><i class="fa fa-minus-circle text-danger" aria-hidden="true"></i>&nbsp;&nbsp;Reminder 2</label>
    <div class="col-md-8 input_f">
        @if($action_type == 'view')
    ...
    <label for="reminder_3" class="col-md-4 col-form-label"><i class="fa fa-plus-circle text-success" aria-hidden="true"></i>&nbsp;&nbsp;Reminder 3</label>
    <div class="col-md-8 input_f">
        @if($action_type == 'view')
    ...
    <label for="description" class="col-md-4 col-form-label"><i class="fa fa-align-left" aria-hidden="true"></i>&nbsp;&nbsp;Description</label>
    <div class="col-md-8 input_f">
    ...
    <div class="col-md-12 text-center pt-3">
        <button class="btn btn-submit event_button" type="submit">
            @if($action_type == 'edit')
            UPDATE
            @else
            SAVE
