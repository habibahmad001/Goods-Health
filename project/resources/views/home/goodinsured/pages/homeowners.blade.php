    ...
    <div class="main">
        ...
        <div class="health_body">
            <div class="col-md-12 health_title">
                <div class="col-md-5">
                    <img src="{{ asset('landing/goodinsured/img/site/icon3.png') }}" alt="" style="width: 85px; ">
                </div>
        ...
        <div class="health_body container-fluid">
            ...
            <div class="col-md-4 desc condo homeowners_feature">
                <img src="{{ asset('landing/goodinsured/img/site/home3.png') }}" alt=""  style="width: 135px !important;"/>
            ...
            <div class="col-md-4 desc condo homeowners_feature">
                <img src="{{ asset('landing/goodinsured/img/site/home-2.png') }}" alt="" style="width: 62px !important;" />
                <h3>Medical Bills</h3>
                <p>Medical payments coverage for minor injuries to people who don't live with you but are injured on your property.</p>
            </div>

            <div class="col-md-4 desc condo homeowners_feature">
                <img src="{{ asset('landing/goodinsured/img/site/renter1.png') }}" alt=""  style="width: 73px !important;" />
        ...
        <div class="health_body container-fluid">
            <div class="desc">
                <img src="{{ asset('landing/goodinsured/img/banner/home1.png') }}" alt="" />
            </div>
        </div>
