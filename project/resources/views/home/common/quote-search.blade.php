...
<div class="quote_rate quote_call">
    <div class="col-md-12">
        <h3>Compare {{ isset($data['compare_title']) ? $data['compare_title'] : "" }} Insurance Rates</h3>
    ...
    <div class="col-md-12">
        <p><img src="{{ asset('landing/goodinsured/img/site/secure.png') }}" width="17px"/> Your information is secure.</p>
    </div>
</div>
