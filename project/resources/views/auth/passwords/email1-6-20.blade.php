...
<body>
<div id="full_wrapper"> <!-- id  was added here -->
    <header>
    ...
    <div class="main"> <!-- class main was added here -->
        <div class="inner_page container">
            <div class="row step cf text-center heading">
                <h4>  <i class="fa fa-user"></i>  FORGET PASSWORD</h4>
            </div>
        </div>
        <div class="container">
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="login_form">
                    <div class="form-group">
                        ...
                        <input id="email" type="email" class="in @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        <br>
                        @error('email')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="in"  data-date="03/14/2019" placeholder="MM/DD/YYYY">
                    </div>
                    <div class="form-group">
                        <input type="submit" class="submit forget" value="{{ __('Send Password Reset Link') }}">
                    </div>
