...
$(document).ready(function(){
   ...
   // }
    ...
    // jQuery(document).on('click','.drop_infomation>a',function () {
    //     $(".drop_infomation").addClass('is-active');
    // });
    // jQuery(document).on('click','.drop_infomation.is-active>a',function () {
    //     $(".drop_infomation").removeClass('is-active');
    // });
    // $(document).on('click','.treeview>a',function () {
    //     $(".treeview").addClass('is-active');
    // });
    // $(document).on('click','.treeview.is-active>a',function () {
    //     $(".treeview").removeClass('is-active');
    // });
