<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('landing/owlcarousel/owl.carousel.min.css')); ?>">
...
<div class="main">
    ...
    <div class="wrapper">
        <div class="banner_con">
            ...
            <div class="insurance_list first owl-carousel owl-theme">
                ...
                <a href="javascript:void(0)" class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/i2.png')); ?>" alt="" />
                    <h3>Condo</h3>
                </a>
                <a href="javascript:void(0)" class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/i3.png')); ?>" alt="" />
                    <h3>Homeowners</h3>
                </a>
                <a href="javascript:void(0)"class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/pet.png')); ?>" alt="" />
                    <h3>Pet</h3>
                </a>
                <a href="javascript:void(0)" class="item">
            ...
            <div class="insurance_list owl-carousel owl-theme">
                <a href="javascript:void(0)" class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/moto.png')); ?>" alt="" />
                    <h3>Motorcycle</h3>
                </a>
                <a href="javascript:void(0)" class="item">
                ...
                <a href="javascript:void(0)"class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/boat.png')); ?>" alt="" />
                    <h3>Boat</h3>
                </a>
                <a href="javascript:void(0)" class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/icon8.png')); ?>" alt="" />
                    <h3>Business Owner</h3>
                </a>
                <a href="javascript:void(0)" class="item">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/rideshare.png')); ?>" alt="" />
                    <h3>Rideshare</h3>
                </a>
            </div>
        </div>
    ...
    <div class="how_bg">
        <div class="wrapper">
            <?php echo $__env->make('home.common.how_it_work', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <div class="wrapper">
        <?php echo $__env->make('home.common.coverage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="how_bg">
        <div class="wrapper">
            <?php echo $__env->make("home.common.service", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    <div class="wrapper">
        <?php echo $__env->make('home.common.faq', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="wrapper">
        ...
        <div class="products index">
            <div class="border-blue product-img product_auto ">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/auto-white.png')); ?>" alt="" />
                <h3>Auto</h3>
            </div>
            <div class="border-blue product-img product_motorcycle">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/motorcycle-white.png')); ?>" alt="" />
                <h3>MOTORCYCLE</h3>
            </div>
            <div class="border-blue  product-img product_atv">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/atv-white.png')); ?>" alt="" />
                <h3>ATV</h3>
            </div>
        </div>
        <div class="products index">
            <div class="border-blue  product-img  product_rv">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/rv-white.png')); ?>" alt="" />
                <h3>RV</h3>
            </div>
            <div class="border-blue  product-img  product_trailer">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/trailer-white.png')); ?>" alt="" />
                <h3>Trailer</h3>
            </div>
            <div class="border-blue product-img  product_mobilehome">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/mobilehome-white.png')); ?>" alt="" />
                <h3>Mobile Home</h3>
            </div>
        </div>
        <div class="products index">
            <div class="border-blue product-img product_rideshare ">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/rideshare-white.png')); ?>" alt="" />
                <h3>Rideshare</h3>
            </div>
            ...
            <div class="border-blue product-img product_boat">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/boat-white.png')); ?>" alt="" />
                <h3>Boats</h3>
            </div>
            ...
            <div class="border-blue product-img product_collectio_auto">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/collection-auto-white.png')); ?>" alt="" />
        ...
        <div class="products index">
            <div class="border-blue product-img product_homeowner">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/homeowner-white.png')); ?>" alt="" />
                <h3>Homeowner</h3>
            </div>
            <div class="border-blue  product-img product_renters">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/renters-white.png')); ?>" alt="" />
                <h3>Renters</h3>
            </div>
            <div class="border-blue product-img product_condo">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/condo-white.png')); ?>" alt="" />
                <h3>Condo</h3>
            </div>
        </div>
        <div class="products index">
            <div class="border-blue product-img  pet_product">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/pet-white.png')); ?>" alt="" />
                <h3>Pet</h3>
            </div>
            <div class="border-blue product-img  flood_product">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/flood-white.png')); ?>" alt="" />
                <h3>Flood</h3>
            </div>
            <div class="border-blue product-img business_owner_product ">
                ...
                <a href="#">LEARN MORE</a>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/business-owner-white.png')); ?>" alt="" />
                <h3>Business Owner</h3>
            </div>
        </div>
        <div class="products index">
            <div class="border-blue product-img  general_liability_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/general-laibility-white.png')); ?>" alt="" />
            ...
            <div class="border-blue product-img product_laibility ">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/liability-white.png')); ?>" alt="" />
            ...
            <div class="border-blue product-img worker_product ">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/workers-white.png')); ?>" alt="" />
        ...
        <div class="products index">
            <div class="border-blue  product-img commercial_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/commercial-white.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img hired_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/hired-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img error_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/error-icon.png')); ?>" alt="" />
        ...
        <div class="products index">
            <div class="border-blue  product-img cyber_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/cyber-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img umbrella_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/umbrella-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img com_pro_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/commercial-property-icon.png')); ?>" alt="" />
        ...
        <div class="products index">
            <div class="border-blue  product-img business_inter_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/business-interup-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img inland_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/inland-icon.png')); ?>" alt="" />
                <h3>INLAND MARINE</h3>
            </div>
            <div class="border-blue  product-img pro_lia_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/product-liability-icon.png')); ?>" alt="" />
        ...
        <div class="products index">
            <div class="border-blue  product-img emp_prectice_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/employment-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img director_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/director-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img event_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/special-event-icon.png')); ?>" alt="" />
                <h3>SPECIAL EVENT</h3>
            </div>
        </div>
        <div class="products index">
            <div class="border-blue  product-img liquity_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/liquity-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img builder_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/builders-icon.png')); ?>" alt="" />
                <h3>BUILDERS RISK</h3>
            </div>
            <div class="border-blue  product-img contract_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/contactor-icon.png')); ?>" alt="" />
        ...
        <div class="products index">
            <div class="border-blue  product-img fidely_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/bond-icon.png')); ?>" alt="" />
            ...
            <div class="border-blue  product-img surety_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/surety-bond-icon.png')); ?>" alt="" />
                <h3>SURETY BONDS</h3>
            </div>
            <div class="border-blue  product-img licese_product">
                ...
                <img src="<?php echo e(asset('landing/goodinsured/img/site/lisence-icon.png')); ?>" alt="" />
    ...
    <div class="contact">
        ...
        <div class="col-md-6 contact1">
            <div>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/contact2.png')); ?>" alt="" />
            </div>
            <div>
                <h3> Buy Online </h3>
                <p>Our easy-to-use tool lets you compare quotes from top providers, all at once and online.</p>
                <div>
                    <input type="text" placeholder=" Zip Code"/><button class="start-button"> Start <img src="<?php echo e(asset('landing/goodinsured/img/site/start-arrow.png')); ?>" alt="" /> </button>
                </div>
                <p class="security-spam-text"> <img class="security-spam" src="<?php echo e(asset('landing/goodinsured/img/site/security.png')); ?>" alt="" />No spam. We take your privacy seriously.</p>
            </div>
        </div>
        <div class="col-md-6 contact2">
            <div>
                <img src="<?php echo e(asset('landing/goodinsured/img/site/contact.PNG')); ?>" alt="" />
            </div>
            <a href="javascript:void(0)" class="get_call" data-toggle="modal" data-target="#exampleModal"> GET A CALL FROM US </a>
            <img class="get_or"  src="<?php echo e(asset('landing/goodinsured/img/site/or.png')); ?>" alt="" />
        </div>
    </div>
    <!-- Modal -->
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('landing/owlcarousel/owl.carousel.min.js')); ?>"></script>
...
<?php echo $__env->make('home.goodinsured.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Goods-Health\project\resources\views/home/goodinsured/pages/index.blade.php ENDPATH**/ ?>