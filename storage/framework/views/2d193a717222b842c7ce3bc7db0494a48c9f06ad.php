    ...
    <div class="main">
        ...
        <div class="health_body">
            <div class="col-md-12 health_title">
                <div class="col-md-5">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/trailer1.png')); ?>" alt="" style="width: 85px; ">
                </div>
        ...
        <div class="gray-color padding-bottom-1">
            <div class="content-container">
                <p class="profile-dubble-bulit set-photo">
                    <img src="<?php echo e(asset('landing/goodinsured/img/site/left-pic-sec.png')); ?>" alt="" />
                </p>
            ...
            <div class="col-md-12 products ">
                ...
                <a href="#" >
                    <div class="motorcycle">
                        <img src="<?php echo e(asset('landing/goodinsured/img/site/icon5.png')); ?>" alt="" />
                        <h4>MOTORCYCLE</h4>
                    </div>
                </a>
                <a href="#" >
                    <div class="atv">
                        <img src="<?php echo e(asset('landing/goodinsured/img/site/atv.png')); ?>" alt="" />
                        <h4>ATV</h4>
                    </div>
                </a>
                <a href="#" >
                ...
                <a href="#" >
                    <div class="auto">
                        <img src="<?php echo e(asset('landing/goodinsured/img/site/colect_auto.png')); ?>" alt="" />
...
<?php echo $__env->make('home.goodinsured.layouts.master', $data, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ssss\project\resources\views/home/goodinsured/pages/auto.blade.php ENDPATH**/ ?>