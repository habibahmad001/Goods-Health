...
<?php $__env->startSection('content'); ?>
    <div class="main">
        ...
        <div class="second_bar margin-bottom-2">
        ...
        <div class="wrapper-margin">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 text-center">
                    ...
                    <!-- <img src="../img/site/ren1.png">
                    <div class="heading-txt text-center">
                        Renters Insurance Coverage
                    </div> -->
                    <div class="content_txt text-center margin-bottom-2">
            ...
            <div class="row margin-bottom-2">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="min-height-100"></div>
                    <div class="content_txt margin-bottom-2">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 text-right">
                    <img src="../img/site/rv01.png">
                </div>
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
            </div>
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-7 col-lg-7 rv-img-setting text-right">
                    <img src="../img/site/rv02.png">
                </div>
                <div class="col-sm-12 col-md-7 col-lg-7 text-center">
                    <img src="../img/site/rv03.png">
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 text-right">
                    <div class="min-height-100"></div>
                    <div class="min-height-100"></div>
            ...
            <div class="row margin-bottom-2">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div class="min-height-100"></div>
                    <div class="content_txt margin-bottom-2">
                        Yes. You must have at least the state minimum for liability, since motorhomes are driven and not towed. All insurers will let you know the minimum requirements in your state, before quoting and failure to carry liability insurance could result in a revoked license, fines, or even jail time.
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 text-right">
                    <div class="inner-settin-full-width rv-img-setting-r">
                        <img src="../img/site/rv04.png">
                    </div>
                    <img src="../img/site/rv05.png">
                </div>
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
            </div>
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-7 col-lg-7 rv-img-setting text-right">
                    <img src="../img/site/rv06.png">
                </div>
                <div class="col-sm-12 col-md-7 col-lg-7 text-center">
                    <img src="../img/site/rv07.png">
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 text-right">
                    <div class="min-height-100"></div>
                    <div class="min-height-100"></div>
                    ...
                    <div class="min-height-100"></div>
                    <div class="content_txt margin-bottom-2">
                        Because you're not actually driving your travel trailer, you aren't required by “law” to have insurance on a vehicle that is being tow with a car or truck. However, your travel trailer is should be protected. Most travel trailer policies include comprehensive coverage. It's up to you if you want to add collision, but most financers will require you to carry both.
                    </div>
                </div>
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
            </div>
        </div>
        <div class="inner-settin-full-width rv-one-bg">
        ...
        <div class="wrapper-margin">
            ...
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
                <div class="col-sm-12 col-md-3 col-lg-3">
                    <img src="../img/site/rv4.png">
                </div>
                <div class="col-sm-12 col-md-7 col-lg-7">
                    <div class="min-height-50"></div>
                    <div class="content_txt margin-bottom-2 text-right">
            ...
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
                <div class="col-sm-12 col-md-10 col-lg-10 rv-10-cal-img">
                    <img src="../img/site/rv13.png">
                </div>
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
            </div>
            <div class="row margin-bottom-2">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="min-height-50"></div>
                    <div class="heading-txt margin-bottom-2 text-center">
                        Tips for quoting RV insurance
                    </div>
                    <div class="min-height-50"></div>
                    <div class="content_txt margin-bottom-2 text-center">
            ...
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-3 col-lg-3"></div>
                <div class="col-sm-12 col-md-6 col-lg-6 text-center">
                    <img class="margin-bottom-2" src="../img/site/rv15.png">
                    <div class="content_txt margin-bottom-2 text-center">
            ...
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-3 col-lg-3"></div>
                <div class="col-sm-12 col-md-6 col-lg-6 text-center">
                    <img class="margin-bottom-2" src="../img/site/rv16.png">
                    <div class="content_txt margin-bottom-2 text-center">
            ...
            <div class="row margin-bottom-2">
                <div class="col-sm-12 col-md-3 col-lg-3"></div>
                <div class="col-sm-12 col-md-6 col-lg-6 text-center">
                    <img class="margin-bottom-2" src="../img/site/rv17.png">
                    <div class="content_txt margin-bottom-2 text-center">
            ...
            <div class="row margin-bottom-2">
                ...
                <div class="col-sm-12 col-md-10 col-lg-10">
                    <div class="heading-txt margin-bottom-2">
            ...
            <div class="row margin-bottom-2">
                ...
                <div class="col-sm-12 col-md-7 col-lg-7">
                    ...
                    <div class="content_txt margin-bottom-2">
                        “Tire blowouts are very common—especially in hotter climates where highways pavement are hot. Research the tire load rating. Use an equalizer system as part of your towing equipment Know the ideal inflation level of your tires
                    </div>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-3 text-center">
                    <img src="../img/site/rv18.png">
                </div>
                <div class="col-sm-12 col-md-1 col-lg-1"></div>
            </div>
            <div class="row margin-bottom-2">
...
<?php echo $__env->make('home.goodinsured.layouts.master', $data, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Goods-Health\project\resources\views/home/goodinsured/pages/GoodInsured_rv.blade.php ENDPATH**/ ?>